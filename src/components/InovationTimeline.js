                ...
                <div className="flex flex-col space-y-0">
                    {timelineData.map((item, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`relative z-5 flex flex-col md:flex-row items-center mb-4 ${isLeft ? 'md:justify-start' : 'md:justify-end'
                                    }`}
                            >
                                ...
                                >
                                    <div className="relative bg-[#10162a] p-6 rounded-lg shadow-lg animated-border mb-4">
